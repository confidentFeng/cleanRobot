/********************************************************************************
** Form generated from reading UI file 'switchMapW.ui'
**
...
public:
    ...
    void setupUi(QDialog *SwitchMapW)
    {
        if (SwitchMapW->objectName().isEmpty())
            SwitchMapW->setObjectName(QStringLiteral("SwitchMapW"));
        SwitchMapW->setEnabled(true);
        SwitchMapW->resize(1024, 768);
        QFont font;
        font.setFamily(QString::fromUtf8("\345\256\213\344\275\223"));
        SwitchMapW->setFont(font);
        titleGroupBox = new QGroupBox(SwitchMapW);
...
"}"));
        ...
        groupBox = new QGroupBox(SwitchMapW);
...
"}"));
        ...
        currentMapLabel = new QLabel(SwitchMapW);
        ...
        returnMapButton = new QPushButton(SwitchMapW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/switchmapimag/pbut_return1.png)}"));
        ...
        retranslateUi(SwitchMapW);

        QMetaObject::connectSlotsByName(SwitchMapW);
    } // setupUi

    void retranslateUi(QDialog *SwitchMapW)
    {
        SwitchMapW->setWindowTitle(QApplication::translate("SwitchMapW", "Dialog", Q_NULLPTR));
        titleGroupBox->setTitle(QString());
        returnMoreButton->setText(QString());
        titleLabel->setText(QApplication::translate("SwitchMapW", "\345\210\207\346\215\242\345\234\260\345\233\276\345\214\205", Q_NULLPTR));
        groupBox->setTitle(QString());
        label->setText(QString());
        currentMapLabel->setText(QApplication::translate("SwitchMapW", "223", Q_NULLPTR));
