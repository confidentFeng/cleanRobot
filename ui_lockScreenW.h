/********************************************************************************
** Form generated from reading UI file 'lockScreenW.ui'
**
...
#ifndef UI_LOCKSCREENW_H
#define UI_LOCKSCREENW_H
...
public:
    ...
    void setupUi(QDialog *LockScreenW)
    {
        if (LockScreenW->objectName().isEmpty())
            LockScreenW->setObjectName(QStringLiteral("LockScreenW"));
        LockScreenW->resize(380, 300);
        QFont font;
        font.setFamily(QString::fromUtf8("\345\256\213\344\275\223"));
        LockScreenW->setFont(font);
        LockScreenW->setFocusPolicy(Qt::ClickFocus);
        LockScreenW->setStyleSheet(QLatin1String("#Widget_Lock\n"
"{\n"
"border-image: url(:/new/prefix1/image/widget_lockimag/bigback_board.png);\n"
"}"));
        titleLabel = new QLabel(LockScreenW);
        ...
        infoLabel = new QLabel(LockScreenW);
        ...
        lineEdit = new QLineEdit(LockScreenW);
...
"border-image: url(:/new/prefix1/image/widget_lockimag/password_board.png);"));
        loginButton = new QPushButton(LockScreenW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/widget_lockimag/ok1.png)}"));
        cancelButton = new QPushButton(LockScreenW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/widget_lockimag/cancel1.png)}"));
        ...
        retranslateUi(LockScreenW);

        QMetaObject::connectSlotsByName(LockScreenW);
    } // setupUi

    void retranslateUi(QDialog *LockScreenW)
    {
        LockScreenW->setWindowTitle(QApplication::translate("LockScreenW", "Dialog", Q_NULLPTR));
        titleLabel->setText(QApplication::translate("LockScreenW", "\345\267\262\351\224\201\345\261\217", Q_NULLPTR));
        infoLabel->setText(QApplication::translate("LockScreenW", "\350\257\267\350\276\223\345\205\245\345\257\206\347\240\201\350\247\243\351\224\201", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("LockScreenW", "\350\257\267\350\276\223\345\205\2456\344\275\215\346\225\260\345\255\227", Q_NULLPTR));
...
namespace Ui {
    class LockScreenW: public Ui_LockScreenW {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LOCKSCREENW_H
