/********************************************************************************
** Form generated from reading UI file 'changePasswdW.ui'
**
...
#ifndef UI_CHANGEPASSWDW_H
#define UI_CHANGEPASSWDW_H
...
public:
    ...
    void setupUi(QDialog *ChangePasswdW)
    {
        if (ChangePasswdW->objectName().isEmpty())
            ChangePasswdW->setObjectName(QStringLiteral("ChangePasswdW"));
        ChangePasswdW->resize(1024, 768);
        QFont font;
        font.setFamily(QString::fromUtf8("\345\256\213\344\275\223"));
        font.setPointSize(16);
        ChangePasswdW->setFont(font);
        ChangePasswdW->setFocusPolicy(Qt::ClickFocus);
        ChangePasswdW->setStyleSheet(QLatin1String("#ChangePasswdW\n"
"{\n"
"border-image: url(:/new/prefix1/image/changepasswordimag/back_board.png);\n"
"}"));
        titleGroupBox = new QGroupBox(ChangePasswdW);
...
"}"));
        ...
        okButton = new QPushButton(ChangePasswdW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/changepasswordimag/ok2.png)}"));
        oldPasswd_lineEdit = new QLineEdit(ChangePasswdW);
...
"color: rgb(208, 208, 208);"));
        ...
        newPasswd_lineEdit = new QLineEdit(ChangePasswdW);
...
"color: rgb(208, 208, 208);"));
        ...
        confirmPasswd_lineEdit = new QLineEdit(ChangePasswdW);
...
"color: rgb(208, 208, 208);"));
        ...
        retranslateUi(ChangePasswdW);

        QMetaObject::connectSlotsByName(ChangePasswdW);
    } // setupUi

    void retranslateUi(QDialog *ChangePasswdW)
    {
        ChangePasswdW->setWindowTitle(QApplication::translate("ChangePasswdW", "Dialog", Q_NULLPTR));
        titleGroupBox->setTitle(QString());
        returnLockButton->setText(QString());
        titleLable->setText(QApplication::translate("ChangePasswdW", "\346\233\264\346\224\271\345\257\206\347\240\201", Q_NULLPTR));
        okButton->setText(QApplication::translate("ChangePasswdW", "\347\241\256\345\256\232", Q_NULLPTR));
        oldPasswd_lineEdit->setText(QApplication::translate("ChangePasswdW", "\345\216\237\345\257\206\347\240\201  \350\257\267\350\276\223\345\205\2456\344\275\215\346\225\260\345\255\227", Q_NULLPTR));
        newPasswd_lineEdit->setText(QApplication::translate("ChangePasswdW", "\346\226\260\345\257\206\347\240\201  \350\257\267\350\276\223\345\205\2456\344\275\215\346\225\260\345\255\227", Q_NULLPTR));
        confirmPasswd_lineEdit->setText(QApplication::translate("ChangePasswdW", "\347\241\256\350\256\244\345\257\206\347\240\201  \350\257\267\350\276\223\345\205\2456\344\275\215\346\225\260\345\255\227", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class ChangePasswdW: public Ui_ChangePasswdW {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CHANGEPASSWDW_H
