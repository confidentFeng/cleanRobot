/********************************************************************************
** Form generated from reading UI file 'showModeW.ui'
**
...
public:
    ...
    void setupUi(QDialog *ShowModeW)
    {
        if (ShowModeW->objectName().isEmpty())
            ShowModeW->setObjectName(QStringLiteral("ShowModeW"));
        ShowModeW->resize(1024, 768);
        QFont font;
        font.setFamily(QString::fromUtf8("\345\256\213\344\275\223"));
        font.setPointSize(20);
        font.setItalic(false);
        ShowModeW->setFont(font);
        ShowModeW->setAutoFillBackground(true);
        titleGroupBox = new QGroupBox(ShowModeW);
...
"}"));
        ...
        okButton = new QPushButton(ShowModeW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/showmodeimag/ok1.png)}"));
        cancelButton = new QPushButton(ShowModeW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/showmodeimag/cancel1.png)}"));
        groupBox = new QGroupBox(ShowModeW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/showmodeimag/manual1.png)}"));
        gapGroupBox = new QGroupBox(ShowModeW);
...
"}"));
        ...
        cruiseGroupBox = new QGroupBox(ShowModeW);
...
"}"));
        ...
        setGroupBox = new QGroupBox(ShowModeW);
...
"}"));
        ...
        currentMapLabel = new QLabel(ShowModeW);
        ...
        mapIndexLabel = new QLabel(ShowModeW);
        ...
        addBoardButton = new QPushButton(ShowModeW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/showmodeimag/add1.png)}"));
        lessBoardButton = new QPushButton(ShowModeW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/showmodeimag/less1.png)}"));
        resetBoardButton = new QPushButton(ShowModeW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/showmodeimag/reset1.png)}"));
        ...
        retranslateUi(ShowModeW);

        QMetaObject::connectSlotsByName(ShowModeW);
    } // setupUi

    void retranslateUi(QDialog *ShowModeW)
    {
        ShowModeW->setWindowTitle(QApplication::translate("ShowModeW", "Dialog", Q_NULLPTR));
        titleGroupBox->setTitle(QString());
        returnMoreButton->setText(QString());
        titleLabel->setText(QApplication::translate("ShowModeW", "\345\261\225\347\244\272\346\250\241\345\274\217", Q_NULLPTR));
        okButton->setText(QApplication::translate("ShowModeW", "\347\241\256\345\256\232", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("ShowModeW", "\345\217\226\346\266\210", Q_NULLPTR));
        ...
        gapOkButton->setText(QApplication::translate("ShowModeW", "\347\241\256\345\256\232", Q_NULLPTR));
        gapLabel->setText(QApplication::translate("ShowModeW", "\351\227\264\351\232\224", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("ShowModeW", "30", Q_NULLPTR));
        cruiseGroupBox->setTitle(QString());
        addItemButton->setText(QApplication::translate("ShowModeW", "\346\267\273\345\212\240\347\202\271", Q_NULLPTR));
        lessItemButton->setText(QApplication::translate("ShowModeW", "\345\210\240\351\231\244\347\202\271", Q_NULLPTR));
        cruiseGroupBox_returnBtn->setText(QString());
        cruiseLabel->setText(QApplication::translate("ShowModeW", "\345\267\241\350\210\252\347\202\271", Q_NULLPTR));
        setGroupBox->setTitle(QString());
        paramButton->setText(QApplication::translate("ShowModeW", "\345\217\202\346\225\260", Q_NULLPTR));
        resetButton->setText(QApplication::translate("ShowModeW", "\351\207\215\350\256\276\345\256\232", Q_NULLPTR));
        setGroupBox_returnBtn->setText(QString());
        currentMapLabel->setText(QApplication::translate("ShowModeW", "\345\275\223\345\211\215\345\234\260\345\233\276\357\274\232", Q_NULLPTR));
        mapIndexLabel->setText(QApplication::translate("ShowModeW", "332", Q_NULLPTR));
