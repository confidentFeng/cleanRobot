/********************************************************************************
** Form generated from reading UI file 'chargingPileSetW.ui'
**
...
#ifndef UI_CHARGINGPILESETW_H
#define UI_CHARGINGPILESETW_H
...
public:
    ...
    void setupUi(QDialog *ChargingPileSetW)
    {
        if (ChargingPileSetW->objectName().isEmpty())
            ChargingPileSetW->setObjectName(QStringLiteral("ChargingPileSetW"));
        ChargingPileSetW->setWindowModality(Qt::WindowModal);
        ChargingPileSetW->resize(1024, 768);
        QFont font;
        font.setFamily(QString::fromUtf8("\345\256\213\344\275\223"));
        ChargingPileSetW->setFont(font);
        titleGroupBox = new QGroupBox(ChargingPileSetW);
...
"}"));
        ...
        setGroupBox = new QGroupBox(ChargingPileSetW);
...
"background-color:transparent;"));
        ...
        addxButton->setStyleSheet(QLatin1String("QPushButton{border-image: url(:/new/prefix1/image/chargingpilesetimag/addmin.png)}\n"
"QPushButton:pressed{border-image: url(:/new/prefix1/image/chargingpilesetimag/addmin1.png)}"));
        ...
        lessxButton->setStyleSheet(QLatin1String("QPushButton{border-image: url(:/new/prefix1/image/chargingpilesetimag/lessmin.png)}\n"
"QPushButton:pressed{border-image: url(:/new/prefix1/image/chargingpilesetimag/lessmin1.png)}"));
        ...
        addyButton->setStyleSheet(QLatin1String("QPushButton{border-image: url(:/new/prefix1/image/chargingpilesetimag/addmin.png)}\n"
"QPushButton:pressed{border-image: url(:/new/prefix1/image/chargingpilesetimag/addmin1.png)}"));
        ...
        lessyButton->setStyleSheet(QLatin1String("QPushButton{border-image: url(:/new/prefix1/image/chargingpilesetimag/lessmin.png)}\n"
"QPushButton:pressed{border-image: url(:/new/prefix1/image/chargingpilesetimag/lessmin1.png)}"));
        ...
        resetBoardButton = new QPushButton(ChargingPileSetW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/chargingpilesetimag/reset1.png)}"));
        addBoardButton = new QPushButton(ChargingPileSetW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/chargingpilesetimag/add1.png)}"));
        lessBoardButton = new QPushButton(ChargingPileSetW);
...
"QPushButton:pressed{border-image: url(:/new/prefix1/image/chargingpilesetimag/less1.png)}"));
        ...
        retranslateUi(ChargingPileSetW);

        QMetaObject::connectSlotsByName(ChargingPileSetW);
    } // setupUi

    void retranslateUi(QDialog *ChargingPileSetW)
    {
        titleGroupBox->setTitle(QString());
        returnMoreButton->setText(QString());
        titleLabel->setText(QApplication::translate("ChargingPileSetW", "\345\205\205\347\224\265\346\241\251\344\275\215\347\275\256\350\256\276\347\275\256", Q_NULLPTR));
        setGroupBox->setTitle(QString());
        chooseGroupBox->setTitle(QString());
        setCurrPointButton->setText(QApplication::translate("ChargingPileSetW", "\350\256\276\345\275\223\345\211\215\347\202\271", Q_NULLPTR));
        manualSetButton->setText(QApplication::translate("ChargingPileSetW", "\346\211\213\345\212\250\350\260\203\350\212\202", Q_NULLPTR));
        label->setText(QApplication::translate("ChargingPileSetW", "\345\235\220\346\240\207\346\230\276\347\244\272", Q_NULLPTR));
        okButton->setText(QApplication::translate("ChargingPileSetW", "\347\241\256\345\256\232", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("ChargingPileSetW", "\345\217\226\346\266\210", Q_NULLPTR));
        xAxisLabel->setText(QApplication::translate("ChargingPileSetW", "X \350\275\264", Q_NULLPTR));
        yAxisLabel->setText(QApplication::translate("ChargingPileSetW", "Y \350\275\264", Q_NULLPTR));
        addxButton->setText(QString());
        lessxButton->setText(QString());
        addyButton->setText(QString());
        lessyButton->setText(QString());
        xLabel->setText(QApplication::translate("ChargingPileSetW", "0", Q_NULLPTR));
        yLabel->setText(QApplication::translate("ChargingPileSetW", "0", Q_NULLPTR));
        resetBoardButton->setText(QString());
        addBoardButton->setText(QString());
        lessBoardButton->setText(QString());
        Q_UNUSED(ChargingPileSetW);
    } // retranslateUi

};

namespace Ui {
    class ChargingPileSetW: public Ui_ChargingPileSetW {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CHARGINGPILESETW_H
